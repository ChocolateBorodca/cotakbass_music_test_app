...
def registration_screen():
    st.markdown("""
        ...
        /* Фикс клика: невидимый загрузчик на всю площадь фигуры */
        ...
        /* Кнопка стрелка */
        .arrow-box { display: flex; justify-content: center; margin-top: 30px; }
        .arrow-box button { background: rgba(255, 255, 255, 0.02) !important; border: 1px solid rgba(160, 32, 240, 0.4) !important; border-radius: 50% !important; color: #A020F0 !important; width: 70px !important; height: 70px !important; font-size: 28px !important; }
        </style>
    ...
    bio = st.text_input("status", placeholder="status")
